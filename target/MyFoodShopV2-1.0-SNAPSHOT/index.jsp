                            ...
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="card-body p-md-5 mx-md-4">
                                        ...
                                        <s:form action="verifyLogin" class="d-flex flex-column">
                                                ...
                                                <s:textfield name="correo" placeholder="Dirección de correo electrónico"/>
                                                <label class="form-label" for="form2Example11">Usuario</label>
                                                <s:password name="digesto"/>
                                                <label class="form-label" for="form2Example22">Contraseña</label>
                                                <s:submit class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3"> Iniciar Sesión</s:submit>
                                        </s:form>
                                ...
                                <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                        ...
                                        <p class="small mb-0">
                                            Con Lotus puedes hacer tus pedidos de comida con la seguridad que nadie más te ofrece.
